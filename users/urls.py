...
from .views import CreateUserView, VerifyAPIView, GetNewVerification, ChangeUserInformationView, ChangeUserPhotoSerializerView, LoginView, LoginRefreshView, logoutView, ForgotPasswordView
